#######################################################
### 1 ### elevation (15 x 15 m integer grid) ########
#######################################################
...
setwd("~/R/proj/basins2019/data")
  zones <- readOGR(".", "cnrfc_zones_07122019_83alb_eacusgs_n") %>% st_as_sf() %>% 
  ...
  #as_tibble(extracted)
  #write_csv(extracted, paste0("elev_newzones.csv"))
